    ...
    <>
      ...
      >
        ...
        <Typography variant="subtitle1" sx={{ py: 6 }}>
          ...
          <br />
          <span style={{ fontWeight: "bold" }}>ShortMesh</span> gives you all
          the tools to build, monitor, and manage social inboxes—your way.
        </Typography>
            ...
            <Grid container spacing={4}>
              <Grid size={{ xs: 12, md: 6 }}>
                ...
                <Typography variant="body1" sx={{ mb: 6 }}>
                  Integrate messages into your stack effortlessly. Build,
                  monitor and manage communications across platforms with ease.
                </Typography>
            ...
            <Grid container spacing={4}>
              <Grid size={{ xs: 12, md: 6 }}>
                ...
                <Typography variant="body1" sx={{ mb: 6 }}>
                  ...
                  place. Monitor engagement and manage your team efficiently.
                </Typography>
                <a href="mailto:developers@smswithoutborders.com?subject=Request%20Demo&body=Hi%20ShortMesh%20Team,%0A%0AI'd%20like%20to%20request%20a%20demo%20of%20your%20platform.%0A%0AThanks!">
                  <Button
                    variant="contained"
      ...
      >
        <Grid container>
          <Grid size={{ xs: 12, md: 7 }}>
            <Typography className="header" variant="h5" sx={{ mb: 4 }}>
              Request Demo
            </Typography>
            <Typography variant="subtitle1" sx={{ mb: 6 }}>
              Be the first to know how ShortMesh works.
            </Typography>

            <Button
              variant="contained"
              size="large"
              sx={{ textTransform: "none", borderRadius: 7, px: 8, py: 1.5 }}
            >
              Request Demo
            </Button>
          </Grid>
          <Grid size={{ xs: 12, md: 5 }}>
            <Box component="img" src="bottom.svg" width="70%" />
          </Grid>
        </Grid>
      </Box> */}
    </>
